...
('s2', 'S2', 'Applicant Details (all profiles)', ARRAY['all'], 'Each writes own profile; Kendo compiles', '22 May', 'not_started', 0, ''),
('s3', 'S3', 'Consortium Collaborations', ARRAY['janin'], 'All orgs write 150–200 words; Janin edits + enters portal', '27 May', 'not_started', 0, ''),
('s4', 'S4', 'Research Proposal', ARRAY['pallavi','ploy'], 'Ploy: framing; AIT: methodology; ERTH: structure', '27 May', 'not_started', 0, ''),
('s5', 'S5', 'Research Involving Human Participants', ARRAY['pallavi'], 'Draft', '24 May', 'not_started', 0, ''),
('s6', 'S6', 'Research Involving Animals', ARRAY['all'], 'Not applicable — confirm in portal', '20 May', 'not_started', 0, ''),
('s7', 'S7', 'Research Management & Infrastructure', ARRAY['janin','ko'], 'Draft (Janin or Ko suggested)', '24 May', 'not_started', 0, ''),
('s8', 'S8', 'Research Outputs Management & Sharing', ARRAY['pallavi'], 'Draft', '24 May', 'not_started', 0, ''),
('s9', 'S9', 'Research Training & Development', ARRAY['aida'], 'Draft (Aida suggested)', '24 May', 'not_started', 0, ''),
('s10', 'S10', 'Timetable & Milestones', ARRAY['janin'], 'All orgs send milestones; Janin builds Gantt; Kendo reviews', '27 May', 'not_started', 0, ''),
('s11', 'S11', 'Consortium Budget Overview', ARRAY['kendo'], 'Each org fills CM sheet; Kendo consolidates', '27 May', 'not_started', 0, ''),
('s12', 'S12', 'Co-Funding', ARRAY['kendo'], 'Draft', '27 May', 'not_started', 0, ''),
('s13', 'S13', 'MEL — Theory of Change & Logframe', ARRAY['pallavi','janin'], 'AIT: ToC narrative + Logframe; Janin: diagram + compile; Kendo: GEDI', '30 May', 'not_started', 0, ''),
('s14', 'S14', 'Public & Policy Engagement', ARRAY['okka','ko'], 'Draft (Okka or Ko suggested)', '24 May', 'not_started', 0, ''),
('s15', 'S15', 'Project Risk Evaluation', ARRAY['pallavi','okka','janin'], 'AIT: data/tech risks; RecyGlo: field risks; Janin: compile; Kendo: financial', '30 May', 'not_started', 0, ''),
('s16', 'S16', 'Environmental Sustainability', ARRAY['janin'], 'Draft (Janin suggested)', '24 May', 'not_started', 0, ''),
('s17', 'S17', 'Reviewer Suggestions', ARRAY['ploy'], 'Optional — Dr. Ploy enters directly in portal', '5 Jun', 'not_started', 0, ''),
('s18', 'S18', 'Eligibility & Consortium Org Chart', ARRAY['janin','kendo'], 'Janin completes in portal; upload org chart; Kendo: S18 eligibility draft', '30 May', 'not_started', 0, ''),
('s19', 'S19', 'E-Signature (PI)', ARRAY['ploy'], 'Dr. Ploy signs after RO approval — final step', '9 Jun', 'not_started', 0, '');
...
('d2', '2', 'LoS — Deputy PI Santhad (institutional, from UPLB)', 'S2', 'santhad', '22 May', 'unverified', 'Unverified (image PDF)'),
