...
('s1', 'S1', 'Application Summary', ARRAY['kendo'], 'Verify carry-over data', '23 May', 'not_started', 0, ''),
...
('s3', 'S3', 'Consortium Collaborations', ARRAY['kendo','santhad','pallavi','okka','hybunna','rhea'], 'All organizations contribute 150-200 words; coordination team edits and enters in portal', '13 Jun', 'not_started', 0, ''),
('s4', 'S4', 'Research Proposal', ARRAY['pallavi','ploy'], 'Lead institution provides framing; AIT provides methodology; ERTH provides structure', '20 Jun', 'not_started', 0, ''),
('s5', 'S5', 'Research Involving Human Participants', ARRAY['pallavi','hybunna','rhea'], 'Draft', '13 Jun', 'not_started', 0, ''),
('s6', 'S6', 'Research Involving Animals', ARRAY['kendo'], 'Consortium-wide ownership — not applicable; project management confirms in portal', '23 May', 'not_started', 0, ''),
('s7', 'S7', 'Research Management & Infrastructure', ARRAY['santhad','aida','ko','kendo'], 'Draft (coordination team suggested)', '6 Jun', 'not_started', 0, ''),
('s8', 'S8', 'Research Outputs Management & Sharing', ARRAY['pallavi','ploy','okka','aida'], 'Draft', '13 Jun', 'not_started', 0, ''),
('s9', 'S9', 'Research Training & Development', ARRAY['ploy','okka','aida','hybunna'], 'Draft (training lead suggested)', '13 Jun', 'not_started', 0, ''),
('s10', 'S10', 'Timetable & Milestones', ARRAY['kendo','janin'], 'All organizations send milestones; coordination team builds Gantt; project management reviews', '17 Jun', 'not_started', 0, ''),
('s11', 'S11', 'Consortium Budget Overview', ARRAY['kendo','ploy','pallavi','okka','rhea','hybunna','aida'], 'Each organization fills CM sheet; project management consolidates', '13 Jun', 'not_started', 0, ''),
('s12', 'S12', 'Co-Funding', ARRAY['kendo','janin'], 'Draft', '30 May', 'not_started', 0, ''),
('s13', 'S13', 'MEL — Theory of Change & Logframe', ARRAY['pallavi','janin','kendo','aida','ko','okka','rhea'], 'AIT: ToC narrative + Logframe; coordination team: diagram + compile; project management: GEDI', '17 Jun', 'not_started', 0, ''),
('s14', 'S14', 'Public & Policy Engagement', ARRAY['okka','rhea','aida'], 'Draft (engagement lead suggested)', '6 Jun', 'not_started', 0, ''),
('s15', 'S15', 'Project Risk Evaluation', ARRAY['pallavi','kendo','janin','ko','ploy'], 'AIT: data/tech risks; RecyGlo: field risks; coordination team: compile; project management: financial', '17 Jun', 'not_started', 0, ''),
('s16', 'S16', 'Environmental Sustainability', ARRAY['okka','janin','ko','kendo'], 'Draft (coordination lead suggested)', '6 Jun', 'not_started', 0, ''),
('s17', 'S17', 'Reviewer Suggestions', ARRAY['ploy'], 'Optional — PI enters directly in portal', '13 Jun', 'not_started', 0, ''),
('s18', 'S18', 'Eligibility & Consortium Org Chart', ARRAY['santhad','janin','kendo'], 'Coordination team completes in portal and uploads org chart; project management drafts S18 eligibility', '30 May', 'not_started', 0, ''),
('s19', 'S19', 'E-Signature (PI)', ARRAY['ploy'], 'PI signs after Research Office approval — final step', '9 Jul', 'not_started', 0, '');
