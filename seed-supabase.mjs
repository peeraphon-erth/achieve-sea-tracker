...
const SECTIONS = [
  ...
  { id: "s2", num: "S2", title: "Applicant Details (all profiles)", leadIds: JSON.stringify(["kendo"]), roleNote: "Consortium-wide ownership: each organization writes its own profile; project management compiles", dueDate: "22 May", status: "not_started", progress: 0, notes: "" },
  { id: "s3", num: "S3", title: "Consortium Collaborations", leadIds: JSON.stringify(["janin"]), roleNote: "All organizations contribute 150-200 words; coordination team edits and enters in portal", dueDate: "27 May", status: "not_started", progress: 0, notes: "" },
  { id: "s4", num: "S4", title: "Research Proposal", leadIds: JSON.stringify(["pallavi", "ploy"]), roleNote: "Lead institution provides framing; AIT provides methodology; ERTH provides structure", dueDate: "27 May", status: "not_started", progress: 0, notes: "" },
  ...
  { id: "s6", num: "S6", title: "Research Involving Animals", leadIds: JSON.stringify(["kendo"]), roleNote: "Consortium-wide ownership — not applicable; project management confirms in portal", dueDate: "20 May", status: "not_started", progress: 0, notes: "" },
  { id: "s7", num: "S7", title: "Research Management & Infrastructure", leadIds: JSON.stringify(["janin", "ko"]), roleNote: "Draft (coordination team suggested)", dueDate: "24 May", status: "not_started", progress: 0, notes: "" },
  ...
  { id: "s9", num: "S9", title: "Research Training & Development", leadIds: JSON.stringify(["aida"]), roleNote: "Draft (training lead suggested)", dueDate: "24 May", status: "not_started", progress: 0, notes: "" },
  { id: "s10", num: "S10", title: "Timetable & Milestones", leadIds: JSON.stringify(["janin"]), roleNote: "All organizations send milestones; coordination team builds Gantt; project management reviews", dueDate: "27 May", status: "not_started", progress: 0, notes: "" },
  { id: "s11", num: "S11", title: "Consortium Budget Overview", leadIds: JSON.stringify(["kendo"]), roleNote: "Each organization fills CM sheet; project management consolidates", dueDate: "27 May", status: "not_started", progress: 0, notes: "" },
  ...
  { id: "s13", num: "S13", title: "MEL — Theory of Change & Logframe", leadIds: JSON.stringify(["pallavi", "janin"]), roleNote: "AIT: ToC narrative + Logframe; coordination team: diagram + compile; project management: GEDI", dueDate: "30 May", status: "not_started", progress: 0, notes: "" },
  { id: "s14", num: "S14", title: "Public & Policy Engagement", leadIds: JSON.stringify(["okka", "ko"]), roleNote: "Draft (engagement lead suggested)", dueDate: "24 May", status: "not_started", progress: 0, notes: "" },
  { id: "s15", num: "S15", title: "Project Risk Evaluation", leadIds: JSON.stringify(["pallavi", "okka", "janin"]), roleNote: "AIT: data/tech risks; RecyGlo: field risks; coordination team: compile; project management: financial", dueDate: "30 May", status: "not_started", progress: 0, notes: "" },
  { id: "s16", num: "S16", title: "Environmental Sustainability", leadIds: JSON.stringify(["janin"]), roleNote: "Draft (coordination lead suggested)", dueDate: "24 May", status: "not_started", progress: 0, notes: "" },
  { id: "s17", num: "S17", title: "Reviewer Suggestions", leadIds: JSON.stringify(["ploy"]), roleNote: "Optional — PI enters directly in portal", dueDate: "5 Jun", status: "not_started", progress: 0, notes: "" },
  { id: "s18", num: "S18", title: "Eligibility & Consortium Org Chart", leadIds: JSON.stringify(["janin", "kendo"]), roleNote: "Coordination team completes in portal and uploads org chart; project management drafts S18 eligibility", dueDate: "30 May", status: "not_started", progress: 0, notes: "" },
  { id: "s19", num: "S19", title: "E-Signature (PI)", leadIds: JSON.stringify(["ploy"]), roleNote: "PI signs after Research Office approval — final step", dueDate: "9 Jun", status: "not_started", progress: 0, notes: "" },
];
