...
const SECTIONS = [
  ...
  { id: "s3", num: "S3", title: "Consortium Collaborations", leadIds: JSON.stringify(["kendo", "janin"]), roleNote: "All organizations contribute 150-200 words; coordination team edits and enters in portal", dueDate: "27 May", status: "not_started", progress: 0, notes: "" },
  ...
  { id: "s7", num: "S7", title: "Research Management & Infrastructure", leadIds: JSON.stringify(["ko"]), roleNote: "Draft (coordination team suggested)", dueDate: "24 May", status: "not_started", progress: 0, notes: "" },
  ...
  { id: "s10", num: "S10", title: "Timetable & Milestones", leadIds: JSON.stringify(["kendo", "janin"]), roleNote: "All organizations send milestones; coordination team builds Gantt; project management reviews", dueDate: "27 May", status: "not_started", progress: 0, notes: "" },
  ...
  { id: "s13", num: "S13", title: "MEL — Theory of Change & Logframe", leadIds: JSON.stringify(["pallavi", "janin", "kendo"]), roleNote: "AIT: ToC narrative + Logframe; coordination team: diagram + compile; project management: GEDI", dueDate: "30 May", status: "not_started", progress: 0, notes: "" },
  { id: "s14", num: "S14", title: "Public & Policy Engagement", leadIds: JSON.stringify(["okka"]), roleNote: "Draft (engagement lead suggested)", dueDate: "24 May", status: "not_started", progress: 0, notes: "" },
  { id: "s15", num: "S15", title: "Project Risk Evaluation", leadIds: JSON.stringify(["pallavi", "ko", "janin"]), roleNote: "AIT: data/tech risks; RecyGlo: field risks; coordination team: compile; project management: financial", dueDate: "30 May", status: "not_started", progress: 0, notes: "" },
  ...
  { id: "s18", num: "S18", title: "Eligibility & Consortium Org Chart", leadIds: JSON.stringify(["janin"]), roleNote: "Coordination team completes in portal and uploads org chart; project management drafts S18 eligibility", dueDate: "30 May", status: "not_started", progress: 0, notes: "" },
